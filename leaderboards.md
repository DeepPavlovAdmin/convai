...
The leaderboard on the [main page]() is the results on the hidden test set for the ConvAI2 competition, which will serve as the main results dictating which models graduate to the Mechanical Turk human evaluation round on September 30th.
...
| -------------        | ---      | :------------- | :-----  |  :----- |
|  [Seq2Seq + Attention](https://github.com/facebookresearch/ParlAI/tree/master/projects/convai2/baselines/seq2seq)  | ParlAI team          | ?&#x1F34E;        | 18.3       | 16.82&#x1F34E; |
