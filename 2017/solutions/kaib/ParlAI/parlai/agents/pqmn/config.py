...
def add_cmdline_args(parser):
    # Runtime environment
    agent = parser.add_argument_group('PQMN Arguments')
    ...
    agent.add_argument('--collect_garbage_every', type=int, default=20)

    # Vocabulary
    agent.add_argument('--vocab_size', type=int, default=85629)
    agent.add_argument('--vocab_size_char', type=int, default=100)
    agent.add_argument('--NULLWORD_Idx_in_char', type=int, default=-1)
    agent.add_argument('--add_char2word', type='bool', default=False)
    agent.add_argument('--qemb_with_wordonly', type='bool', default=False)
    agent.add_argument('--nLayer_Highway', type=int, default=0)

    # Answer Sentence Prediction
    agent.add_argument('--ans_sent_predict', type='bool', default=False)
    agent.add_argument('--nLayer_Sent', type=int, default=1)
    agent.add_argument('--task_QA', type='bool', default=True)
    agent.add_argument('--coeff_ans_predict', type=float, default = 0.1)
    ...
    agent.add_argument('--max_word_len', type=list, default=15, help=('maximum #char per word'))
    agent.add_argument('--hidden_size_sent', type=int, default=128, help='Hidden size of sentence BRNN units')
    agent.add_argument('--hidden_size_bottleneck', type=int, default=64, help='Hidden size of RNN units')

    agent.add_argument('--qp_bottleneck', type='bool', default=True,
                        help='---')
    agent.add_argument('--qp_birnn', type='bool', default=True,
                        help='----')
    agent.add_argument('--qp_concat', type='bool', default=False,
                        help='----')
    agent.add_argument('--pp_bottleneck', type='bool', default=True,
                        help='-----')
    agent.add_argument('--pp_rnn_size', type=int, default=128,
                        help='---')
    agent.add_argument('--pp_birnn', type='bool', default=True,
                        help='----')
